// Sample data for the backend - self-contained to avoid import issues
...
const createEstimatedEquipment = (projectId) => [
  {
    id: generateUniqueId(),
    projectId,
    type: 'Servidor',
...
const createEquipments = (deliveryNoteId, count, estimatedEquipmentId = null) => {
  const equipments = [];
...
const createDeliveryNotes = (orderId) => {
  const notes = [];
